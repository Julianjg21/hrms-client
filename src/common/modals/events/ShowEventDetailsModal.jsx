      ...
      <Modal.Body className="border border-bottom-0 border-top-0 border-dark">
        ...
        <div className="mt-4 mb-2 border p-1">
          <div className="row mt-1">
            <div className="col-6"><p className="text-secondary fw-bolder ">Lugar o link:</p></div>
            <div className="col-6">  <p className="">{eventDetails.ubication}</p></div>
          </div>
        ...
        <div className="mt-2 mb-2">
          ...
          <div className="border  p-1">
            ...
            <div className="row">
              <div className="col-6 text-secondary fw-bolder">Finalizacíon:</div>
              <div className="col-6">
