...
function EmployeeMenuButtons() {
  ...
  return (
    <div className=" btn-group-vertical p-0">
      <Button variant="outline-dark" className=" border-warning rounded-0 text-start " title="Seccion Datos Personales" onClick={() => navigate('userManagement')}>
      <FontAwesomeIcon icon={faUserGroup} className="text-secondary"
      />  Datos Personales
      </Button>
      <Button variant="outline-dark" title="Seccion Solicitudes de Documentos"  className=" border-warning rounded-0 text-start" >
      <IoIosNavigate className="text-secondary me-1"/> Solicitudes de Documentos
      </Button>
      <Button variant="outline-dark" title="Seccion Mis Extractos  Nomina"  className=" border-warning rounded-0 text-start">
      <FaFileAlt icon={faBusinessTime} className="text-secondary me-1"/>Mis Extractos  Nomina
      </Button>
      <Button variant="outline-dark" title="Seccion Calendario" className=" border-warning rounded-0 text-start">
      <BsFillCalendarDateFill className="text-secondary me-1"/>Calendario
      </Button>
      <Button variant="outline-dark" title="Seccion Horario/Turnos" className=" border-warning rounded-0 text-start">
